...
public class MySQLReauthPluginTransactionTestCase {
    ...
    static class MySQLReauthServerSetupTask extends JcaMgmtServerSetupTask {
        ...
        protected void doSetup(ManagementClient managementClient) throws Exception {
            ...
            address.add("jdbc-driver", MYSQL_DRIVER);

            ModelNode operation = new ModelNode();
            operation.get(OP).set(ADD);
            operation.get(OP_ADDR).set(address);
            operation.get("driver-name").set(MYSQL_DRIVER);
            operation.get("driver-module-name").set("com.mysql");
            operation.get("driver-class-name").set("com.mysql.cj.jdbc.Driver");
            operation.get("driver-xa-datasource-class-name").set("com.mysql.cj.jdbc.MysqlXADataSource");
